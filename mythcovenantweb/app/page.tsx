...
export default function Home() {
  return (
    <>
      <BackgroundVideo />
      <main className="relative min-h-screen z-10 px-4 py-6 text-slate-50 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-8 rounded-[2rem] border border-white/10 bg-slate-950/40 p-5 shadow-[0_0_80px_rgba(0,0,0,0.35)] backdrop-blur-sm sm:p-8 lg:p-10">
          ...
          <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            ...
            <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6 shadow-lg backdrop-blur-md">
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-4 shadow-md backdrop-blur-sm">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-md backdrop-blur-sm">
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {features.map((feature) => {
              ...
              return (
                <article
                  key={feature.title}
                  className="rounded-[1.5rem] border border-white/10 bg-white/5 p-5 shadow-lg backdrop-blur-md"
                >
